...
```
[build] final ROM sha1 d1c9353b43d8cffb7124996d4b7f808aa7976219  (MATCHES the shipped translation)
[build] wrote sd-gundam-g-generation-zh.nds  (30,349,672 bytes)
```

追加 `--pad32m 路径` 可同时输出补齐到 32 MiB 的镜像（部分烧录卡要求 2 的幂
大小；sha1 `1b4cc9f204a242ca09bc72384f8f4558faed5278`）。
