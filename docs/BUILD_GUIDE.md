...
* Output: `sd-gundam-g-generation-zh.nds`, 30,359,400 B, sha1
  `67a1132b21e2f9f40252aa25e194fdbe6f22323f`; with `--pad32m` also the 32 MiB 0xFF-padded
  image (sha1 `00fa36d068d1fff331e020df24519d8d0a5b73f6`). (`data/manifest.json` is the
