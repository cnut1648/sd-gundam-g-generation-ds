...
| dialogue nameplate setup | `0x2BCA6` / `0x2BCE8` | style `2→3` selects renderA 12×12; `adds r2,r1,#0` → `movs r2,#3` supplies the plate-only +3px baseline anchor before the call to `0x02013C00` |
